 ...
 *
 * PORTED VERBATIM from frontend/src/lib/worldGraph.ts (only the type import
 * changed). This logic — layering, shelf packing, the connectivity audit — was
 * already correct and already React-free, so it is reused rather than rewritten.
 *
